...
class InvoiceController extends Controller
{
    ...
    protected function payBraintree(string $id)
    {
        ...
        $invoice = Invoice::where('id', $id)->where('WorkOrderNo', '=')->firstOrFail();
...
//                handlePaymentMethodAttached($paymentMethod);
    ...
    protected function recordPaymentAndSendReceipt($customer, $invoiceId, $email, $paymentAmount, $paymentMethod, $transactionId)
    {
        ...
        $fmResult = FM::connection('fm-LPSdata')->layout(config('portal.payments.payment-received-layout'))->performScript(config('portal.payments.payment-received-script'), $scriptParam);
